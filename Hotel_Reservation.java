...
public class Hotel_Reservation {
    ...
    private static final String password = "Prern@108";
            ...
            while(true)
            {
                ...
                switch(choice)
                {
                    ...
                    case 3:
                           ...
                           break;
                    case 4:
                           updateReservations(statement,scanner);
                           break;
                    case 5:
                           deleteReservations(statement,scanner);
                           break;
                    case 0:
                           exit();
                           scanner.close();
    ...
    public static void reserveRoom(Scanner scanner, Statement statement)
    {
        try
        {
    ...
    public static void getRoomNumber(Statement statement, Scanner scanner)
    {
        try {
    ...
    public static void updateReservations(Statement statement ,  Scanner scanner)
    {
        try
        {
    ...
    public static void deleteReservations(Statement statement,Scanner scanner)
    {
        try 
        {
